...
body{ background-color: rgba(221,231,231,0.88);
}
</style>
<body>
    <!-- ##### Preloader ##### -->
...
<caption><button class="btn btn--radius-2 btn--blue" type="submit"><a href="admission.jsp" style="color:white; font-size:20px;"> <-- Go Back</a></button></caption>
<tr>
<th>Categories</th>
<th>Primary </th>
<th>Secondary</th>
