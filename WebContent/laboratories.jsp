            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 rs-vertical-bottom mobile-mb-50">
							...
							<img src="./ss_files/th.jpg" width="600px" height="370px" alt="History Image">
                    </div>
                    <div class="col-lg-6 col-md-12">
		                <div class="abt-title">
		                   <center> <h2>Computer Lab</h2></center>
		                </div>
