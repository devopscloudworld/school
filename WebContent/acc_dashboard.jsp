            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="academy-buttons-area mb-500">
                        <a href="collection_of_students.jsp" target="newfrm" class="btn academy-btn m-4">Collection Summary</a>
                        <a href="Acc_Collection_Donation.jsp"  target="newfrm" class="btn academy-btn btn-2 m-3">Other Collection</a>
                        <a href="acc_Expenses.jsp"  target="newfrm" class="btn academy-btn btn-3 m-3">Expenses</a>
                       <a href="balance_sheet.jsp"  target="newfrm" class="btn academy-btn btn-4 m-3">Balance Sheet</a>
                    </div>
                </div>
<div class="frm">
