        ...
        <div class="container-fluid" style="padding-left:70px;">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <center></center>
                        <a href="principal_Admission_Details.jsp" target="newfrm" class="btn academy-btn m-2" style="align:center;">Admissions </a>
                        <a href="principal_Staff_Details.jsp" target="newfrm" class="btn academy-btn btn-3 m-2">Staff Details</a>
                        <a href="principal_Student_Details.jsp" target="newfrm" class="btn academy-btn btn-4 m-2">Students Details</a>
                        <a href="principal_Leaves_Details.jsp" target="newfrm" class="btn academy-btn btn-5 m-2">Leaves Details</a>
                         <!-- <a href="principal_Student_Strength.jsp" target="newfrm"  class="btn academy-btn btn-6 m-3">Students Strength</a>-->
                        <a href="principal_Daily_Collection.jsp" target="newfrm"  class="btn academy-btn btn-7 m-2">Collections</a>
                         <a href="principal_Fee_Structure.jsp" target="newfrm" class="btn academy-btn btn-8 m-2">Fee Structure</a>
                         <a href="principal_report.jsp" target="newfrm" class="btn academy-btn btn-8 m-2" style="width:170px;">Report</a>
                        <!-- <a href="#" class="btn academy-btn btn-4 m-3">Contact Us</a>-->
                    </center>
                    </div>
                </div>
<div class="frm">
<iframe id="newfrm" name="newfrm" scrolling="yes" height=600px width=100%></iframe>
</div>
</div>
</div>
</section>
