            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="academy-buttons-area mb-500">
                     <a href="applicationInfo.jsp" target="newfrm" class="btn academy-btn btn-5 m-2">Applications</a>
                        <a href="head_Add_Staff.jsp" target="newfrm" class="btn academy-btn m-2">Add Staff</a>
                        <a href="head_GrantedStaff_Details.jsp"target="newfrm" class="btn academy-btn btn-2 m-2">Granted Staff</a>
                        <a href="head_NongrantedStaff_Details.jsp" target="newfrm"class="btn academy-btn btn-3 m-2">NonGranted Staff</a>
                       <a href="head_Add_Students.jsp" target="newfrm"class="btn academy-btn btn-4 m-2">Add Students</a>
                       <a href="head_Students_Details.jsp"target="newfrm" class="btn academy-btn btn-5 m-2">Students</a>
                       <a href="AddHoliday.jsp"target="newfrm" class="btn academy-btn btn-5 m-2">Add Holiday</a>
                          <a href="viewHoliday.jsp"target="newfrm" class="btn academy-btn btn-5 m-2">Holiday</a>
                    </div>
                </div>
