...
{	
	...
	ResultSet rs;
	PreparedStatement ps=con.prepareStatement("select * from staff where staff_type='Granted' && staff_depart=?");
 ...
 <tr>
      ...
      <td><%=rs.getString("staff_education")%></td>
       <td><%=rs.getString("staff_depart")%></td>
        ...
        <td><center><a href='edit_Staff_Details.jsp?id=<%=rs.getString("staff_id")%>'><button class= "btn" value="edit">edit</button></a>
        &nbsp;<a href='delete_Staff_Details.jsp?id=<%=rs.getString("staff_id")%>'><button class= "btn" value="delete">delete</button></a></center></td>
    </tr>
